...
const AjoutPartie: React.FC = () => {
    ...
    */
    ...
    /**
     * 
     * fonction pour faire la requête d'ajout de partie
     */
    ...
    /**
     * trouve un deck selon son nom (utilisé quand on a pas l'id du deck)
     */
    ...
    return (
        <div className="ajout-deck-container">
            ...
            <form onSubmit={handleAjout}>
                ...
                <hr />
                <button type="submit" className='text'>ajouter la partie</button>
            </form>
